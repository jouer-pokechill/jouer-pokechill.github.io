...
document.addEventListener("contextmenu", e => {
    ...
    if (el.dataset.help !== undefined) {
        ...
        if (el.dataset.help === `Frontier`) document.getElementById("tooltipTitle").innerHTML = t("help.frontier.title", "Battle Frontier")
        if (el.dataset.help === `Frontier`) document.getElementById("tooltipBottom").innerHTML = t(
            "help.frontier.body",
        ...
        if (el.dataset.help === `searchDictionary`) document.getElementById("tooltipBottom").innerHTML = t("help.dictionary.body", "Operators:<br>![keyword]: Exclude from search<br>[keywordA] or [keywordB]: Search keywordA OR keywordB<br>[keywordA] [keywordB]: Search for keywordA AND keywordB<br><br>Pokemon keywords:<br>unobtainable, wild, park, event, frontier, shiny, caught, [type], [hidden ability]<br><br>Move keywords:<br>physical, special, [type], [ability]")
        if (el.dataset.help === `searchDictionary`) document.getElementById("dictionary-search").blur()


        if (el.dataset.help === `searchPokedex`) document.getElementById("tooltipTitle").innerHTML = t("help.keywords", "Keywords")
        if (el.dataset.help === `searchPokedex`) document.getElementById("tooltipBottom").innerHTML = t("help.pokedex.body", "Operators:<br>![keyword]: Exclude from search<br>[keywordA] or [keywordB]: Search keywordA OR keywordB<br>[keywordA] [keywordB]: Search for keywordA AND keywordB<br><br>Keywords:<br>shiny, pokerus, [type], [ability], [hidden ability], [level], [move]")
